...
public class Roulette extends Functions implements ScriptFile
{
	...
	public void dialog()
	{
		...
		show(Files.read("data/scripts/services/roulette.htm", player).replaceFirst("%min%", Util.formatAdena(ConfigValue.RouletteMinBet)).replaceFirst("%max%", Util.formatAdena(ConfigValue.RouletteMaxBet)), player);
	}
	...
	public void onLoad()
	{
		_log.info("Loaded Service: Roulette");
	}
