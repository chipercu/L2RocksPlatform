...
public class ai_elite_krakian extends AnnihilationFighter
{
	public ai_elite_krakian(L2NpcInstance self)
	{
		super(self);
	}

	public int Skill01_ID = 420282369;
	public int Skill01_Probablity = 10;
	public int Skill01_Target_Type = 0;
	public int Skill02_ID = 420347905;
	public int Skill02_Probablity = 10;
	public int Skill02_Target_Type = 2;
	public int SpecialSkill01_ID = 420413441;
