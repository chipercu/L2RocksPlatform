...
public class ai_elite_bgurent extends AnnihilationFighter
{
	public ai_elite_bgurent(L2NpcInstance self)
	{
		super(self);
	}

	public int Skill01_ID = 418250753;
	public int Skill01_Probability = 10;
	public int Skill01_Target_Type = 0;
	public int Skill02_ID = 418381825;
	public int Skill02_Probability = 15;
	public int Skill02_Target_Type = 1;
	public int SpecialSkill01_ID = 418316289;
	...
	public void onEvtSpawn()
	{
		...
		for(i0 = 0; i0 < 3;i0++)
		{
			...
			{
				case 0:
					myself.CreateOnePrivateEx(1022747,"SeedOfAnnihilation.brakian",0,1,myself.getX()+Rnd.get(60, 150),myself.getY()+Rnd.get(60, 150),myself.getZ(),0,0,0,0);
					break;
				case 1:
