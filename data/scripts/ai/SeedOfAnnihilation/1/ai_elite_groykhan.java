...
public class ai_elite_groykhan extends AnnihilationFighter
{
	public ai_elite_groykhan(L2NpcInstance self)
	{
		super(self);
	}

	public int Skill01_ID = 418512897;
	public int Skill01_Probability = 30;
	public int Skill01_Target_Type = 0;
	public int Skill02_ID = 418578433;
