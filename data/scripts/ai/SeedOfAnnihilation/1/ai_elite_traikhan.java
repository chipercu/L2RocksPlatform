...
public class ai_elite_traikhan extends AnnihilationFighter
{
	public ai_elite_traikhan(L2NpcInstance self)
	{
		super(self);
	}

	public int Skill01_ID = 418447361;
	public int Skill01_Probability = 15;
	public int Skill01_Target_Type = 0;
	public int Skill02_ID = 418643969;
