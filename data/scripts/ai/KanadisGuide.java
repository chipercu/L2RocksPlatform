...
public class KanadisGuide extends Fighter
{
	...
	public KanadisGuide(L2NpcInstance actor)
	{
		super(actor);
	}
	...
	protected void onEvtSpawn()
	{
		...
		ThreadPoolManager.getInstance().schedule(new spawnTask(actor), 31000);
	}

	private class spawnTask extends l2open.common.RunnableImpl
	{
		private final L2NpcInstance actor;

		public spawnTask(final L2NpcInstance _npc)
		{
			actor = _npc;
		}
	...
	protected void ATTACKED(L2Character attacker, int damage, L2Skill skill)
	{
		...
		{
			actor.addDamageHate((L2NpcInstance) attacker, 0, 1);
