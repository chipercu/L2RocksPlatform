...
public class BelethClone extends Mystic
{
	...
	public BelethClone(L2Character actor)
	{
		super(actor);
		AI_TASK_DELAY = 1000;
	...
	protected void onEvtSeeSpell(L2Skill skill, L2Character caster)
	{
		...
		if (npc != null && !npc.isDead() && (npc.getNpcId() == 29119) && !npc.isCastingNow() && skill.getSkillType() == L2Skill.SkillType.HEAL && Rnd.get(100) < 80 && Util.checkIfInRange(600, npc, caster, false))
		{
			clearTasks();
