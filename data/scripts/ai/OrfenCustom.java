...
import npc.model.CustomOrfenInstance;

public class OrfenCustom extends Fighter
{
	...
	public OrfenCustom(L2Character actor)
	{
		super(actor);
	...
	protected boolean thinkActive()
	{
		if(super.thinkActive())
			return true;
		CustomOrfenInstance actor = getActor();
		if(actor == null)
			return true;
	...
	@Override
	public CustomOrfenInstance getActor()
	{
		return (CustomOrfenInstance) super.getActor();
	}
