...
/**
 * @author: Drizzy
 * АИ для войнов в плейн оф лизардмен.
 */

public class ai_tantaar_lizard_warrior extends Fighter
{
	...
	public ai_tantaar_lizard_warrior(L2Character actor)
	{
		super(actor);
		myself = actor;
	}
	...
	protected void MY_DYING(L2Character killer)
	{
		if(IsNullCreature(c_ai0) == 0)
		{
			...
			if(Rnd.get(1000) == 0 && getActor().getNpcId() != 18862)
		...
		{
			CreateOnePrivateEx(18862,"PlainsOfLizardmen.ai_tantaar_lizard_warrior","L2Monster", "ID", c_ai0 == null ? 0 : c_ai0.getObjectId(),getActor().getX(),getActor().getY(),getActor().getZ(), 0);
		}
