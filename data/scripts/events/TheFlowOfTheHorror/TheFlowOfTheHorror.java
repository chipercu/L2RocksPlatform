...
public class TheFlowOfTheHorror extends Functions implements ScriptFile
{
	...
	private static HardReference<? extends L2NpcInstance> oldGilmore = HardReferences.emptyRef();
	...
	private void deactivateAI()
	{
		...
		L2NpcInstance GilmoreInstance = oldGilmore.get();
