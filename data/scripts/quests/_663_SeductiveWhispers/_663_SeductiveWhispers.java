...
public class _663_SeductiveWhispers extends Quest implements ScriptFile
{
	...
	private final static LevelRewards[] rewards = {
			...
			new LevelRewards("%n% adena, %n% recipe(s) for a B-grade Weapon").add(ADENA_ID, 388000).add(ConfigValue.Alt100PercentRecipesB ? Recipes_Weapon_B_100P : Recipes_Weapon_B, 1),
	...
	public String onKill(L2NpcInstance npc, QuestState qs)
	{
		if(qs.getState() == STARTED)
		{
			...
			qs.rollAndGive(Spirit_Bead, (int)(1 * ConfigValue.RateQuestsDrop), rand);
		}
		return null;
	}
	...
	private static class LevelRewards
	{
		...
		{
			int cnt = (int) (count * ConfigValue.RateQuestsRewardDrop);
