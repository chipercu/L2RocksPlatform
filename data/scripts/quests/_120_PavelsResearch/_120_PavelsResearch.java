...
public class _120_PavelsResearch extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("32041-32.htm"))
		{
			...
			st.giveItems(ADENA_ID, 783729 + Math.round(Math.min(0, 227500 * (st.getRateQuestsRewardAdena() - 1))), true);
		...
		else if(event.equalsIgnoreCase("32045-02.htm"))
		{
			...
			if(player != null)
				npc.broadcastPacket2(new MagicSkillUse(npc, player, 5073, 5, 1500, 0));
		}
