...
public class _373_SupplierOfReagents extends Quest implements ScriptFile
{
	...
	private static final Object[][] ITEMS = {
			...
			{ ConfigValue.Alt100PercentRecipesB ? 4150 : 4953, "etc_recipe_red_i00",
					String.format("Recipe: Avadon Gloves (%d%%)", ConfigValue.Alt100PercentRecipesB ? 100 : 60), "" },
			{ ConfigValue.Alt100PercentRecipesB ? 4177 : 4960, "etc_recipe_red_i00",
					String.format("Recipe: Zubei's Gauntlets (%d%%)", ConfigValue.Alt100PercentRecipesB ? 100 : 60), "" },
			{ ConfigValue.Alt100PercentRecipesB ? 4175 : 4959, "etc_recipe_red_i00",
					String.format("Recipe: Avadon Boots (%d%%)", ConfigValue.Alt100PercentRecipesB ? 100 : 60), "" },
			{ ConfigValue.Alt100PercentRecipesB ? 4174 : 4958, "etc_recipe_red_i00",
					String.format("Recipe: Zubei's Boots (%d%%)", ConfigValue.Alt100PercentRecipesB ? 100 : 60), "" },
			{ ConfigValue.Alt100PercentRecipesB ? 4173 : 4998, "etc_recipe_red_i00",
					String.format("Recipe: Blue Wolf Gloves (%d%%)", ConfigValue.Alt100PercentRecipesB ? 100 : 60), "" },
			{ ConfigValue.Alt100PercentRecipesB ? 4167 : 4992, "etc_recipe_red_i00",
					String.format("Recipe: Blue Wolf Boots (%d%%)", ConfigValue.Alt100PercentRecipesB ? 100 : 60), "" },
			{ ConfigValue.Alt100PercentRecipesB ? 4168 : 4993, "etc_recipe_red_i00",
					String.format("Recipe: Doom Gloves (%d%%)", ConfigValue.Alt100PercentRecipesB ? 100 : 60), "" },
			{ ConfigValue.Alt100PercentRecipesB ? 4176 : 4999, "etc_recipe_red_i00",
					String.format("Recipe: Doom Boots (%d%%)", ConfigValue.Alt100PercentRecipesB ? 100 : 60), "" },
