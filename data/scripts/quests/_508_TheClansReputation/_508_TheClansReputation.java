...
public class _508_TheClansReputation extends Quest implements ScriptFile
{
	...
	private static final int[][] REWARDS_LIST = { { 0, 0 }, { PALIBATI_QUEEN_THEMIS, THEMIS_SCALE, 85 },
			{ Shilens_Priest_Hisilrome, Hisilromes_Heart, 65 }, { GARGOYLE_LORD_TIPHON, TIPHON_SHARD, 50 },
			{ LAST_LESSER_GIANT_GLAKI, GLAKIS_NECLEUS, 125 }, { RAHHA, RAHHAS_FANG, 71 },
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		else if(Util.isIntNumber(event))
		{
	...
	public String onKill(L2NpcInstance npc, QuestState st)
	{
		...
		if(clan_leader == null)
			return null;
		if(!st.getPlayer().equals(clan_leader) && clan_leader.getDistance(npc) > ConfigValue.AltPartyDistributionRange)
			return null;
