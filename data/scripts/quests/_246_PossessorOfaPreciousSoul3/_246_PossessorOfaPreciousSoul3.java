...
public class _246_PossessorOfaPreciousSoul3 extends Quest implements ScriptFile
{
	...
	public _246_PossessorOfaPreciousSoul3()
	{
		...
		addQuestItem(RING_OF_GODDESS_WATERBINDER, NECKLACE_OF_GODDESS_EVERGREEN, STAFF_OF_GODDESS_RAIN_SONG, STAFF_OF_GODDES);
	}
	...
	public String onKill(L2NpcInstance npc, QuestState st)
	{
		...
		if(cond == 2)
		{
			...
			{
				if(st.getPlayer().getVarB("buy_quest_noble", false))
				{
