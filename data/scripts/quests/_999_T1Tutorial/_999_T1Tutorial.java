...
public class _999_T1Tutorial extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("isle"))
		{
			...
			htmltext = "<html><body>" + title + "<br>Пожалуйста, разыщите <font color=\"LEVEL\">Помощника Новичков </font> в <font color=\"LEVEL\">Деревне Камаэль</font>, столице Камаэль. Он даст Вам множество важных подсказок и предмет, который пригодиться в Ваших путешествиях. <br>Вы можете найти Помощника Новичков, следуя в направлении, которое указываетстрелка у Вас над головой. Удачи и счастливого пути!</body></html>";
		}
		else
		{
	...
	public static class DropGem extends RunnableImpl
	{
		...
		public DropGem(L2NpcInstance npc, QuestState st)
		{
			_npc = npc;
			_st = st;
		}
