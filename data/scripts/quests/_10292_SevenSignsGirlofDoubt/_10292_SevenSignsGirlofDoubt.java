...
public class _10292_SevenSignsGirlofDoubt extends Quest implements ScriptFile
{
	...
	public _10292_SevenSignsGirlofDoubt()
	{
		...
		addStartNpc(WOOD);
		addTalkId(WOOD, FRANZ, ELCARDIA, HARDIN, JAINA);
		addKillId(MOBS_1);
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("spawnTestMobs"))
		{
			...
			addSpawnToInstance(CREATURE_OF_THE_DUSK_1, new Location(89416, -237992, -9632, 0), 1, reflectId);
			addSpawnToInstance(CREATURE_OF_THE_DUSK_2, new Location(89416, -238136, -9632, 0), 1, reflectId);
			return null;
		}
		return htmltext;
	}
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		switch(npcId)
		{
			case WOOD:
				if(cond == 0)
				{
					QuestState qs = player.getQuestState("_198_SevenSignsEmbryo");
