...
public class _236_SeedsOfChaos extends Quest implements ScriptFile
{
	...
	// Chances
	private final static int BLACK_ECHO_CRYSTAL_CHANCE = (int) (15 * ConfigValue.RateQuestsDrop);
	private final static int SHINING_MEDALLION_CHANCE = (int) (20 * ConfigValue.RateQuestsDrop);
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		{
			st.giveItems(SCROLL_ENCHANT_WEAPON_A, 1, ConfigValue.RateQuestsRewardOccupationChange);
	...
	public static class OnDespawn extends l2open.common.RunnableImpl
	{
