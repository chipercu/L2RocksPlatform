...
public class _222_TestOfDuelist extends Quest implements ScriptFile
{
	...
	private static final int[][] DROPLIST_COND = { { 2, 0, Puncher, 0, PunchersShard, 10, 70, 1 },
			{ 2, 0, NobleAntLeader, 0, NobleAntsFeeler, 10, 70, 1 }, { 2, 0, MarshStakatoDrone, 0, DronesChitin, 10, 70, 1 },
			{ 2, 0, DeadSeeker, 0, DeadSeekerFang, 10, 70, 1 }, { 2, 0, BrekaOrcOverlord, 0, OverlordNecklace, 10, 70, 1 },
			{ 2, 0, FetteredSoul, 0, FetteredSoulsChain, 10, 70, 1 },
			{ 2, 0, LetoLizardmanOverlord, 0, ChiefsAmulet, 10, 70, 1 },
			{ 2, 0, EnchantedMonstereye, 0, EnchantedEyeMeat, 10, 70, 1 }, { 2, 0, TamlinOrc, 0, TamrinOrcsRing, 10, 70, 1 },
			{ 2, 0, TamlinOrcArcher, 0, TamrinOrcsArrow, 10, 70, 1 }, { 4, 0, Excuro, 0, ExcurosSkin, 3, 70, 1 },
			{ 4, 0, Krator, 0, KratorsShard, 3, 70, 1 }, { 4, 0, Grandis, 0, GrandisSkin, 3, 70, 1 },
			{ 4, 0, TimakOrcOverlord, 0, TimakOrcsBelt, 3, 70, 1 }, { 4, 0, Lakin, 0, LakinsMace, 3, 70, 1 } };
	...
	public _222_TestOfDuelist()
	{
		...
		addQuestItem(new int[] { OrderGludio, OrderDion, OrderGiran, OrderOren, OrderAden, ExcurosSkin, KratorsShard,
				GrandisSkin, TimakOrcsBelt, LakinsMace, FinalOrder });
	}
		...
		if(npcId == Kaien)
			...
			else if(cond == 5)
			{
				...
				if(!st.getPlayer().getVarB("prof2.3"))
				{
					...
					st.giveItems(ADENA_ID, 80000, ConfigValue.RateQuestsRewardOccupationChange); // FIXME: цифра с потолка
