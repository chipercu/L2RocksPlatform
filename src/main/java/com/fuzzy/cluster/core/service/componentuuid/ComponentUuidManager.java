package com.fuzzy.cluster.core.service.componentuuid;
...
public class ComponentUuidManager {
    ...
    public String getUuid(Class<? extends Component> classComponent) {
        return uuids.computeIfAbsent(classComponent, aClass -> {
            com.fuzzy.cluster.anotation.Info aComponent = aClass.getAnnotation(com.fuzzy.cluster.anotation.Info.class);
            if (aComponent == null) {
