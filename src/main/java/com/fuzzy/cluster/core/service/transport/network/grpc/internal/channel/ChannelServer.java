...
import com.fuzzy.cluster.core.service.transport.network.grpc.internal.utils.convert.ConvertProto;
...
public class ChannelServer extends ChannelImpl {
    ...
    @Override
    public com.fuzzy.cluster.core.service.transport.network.grpc.internal.channel.ChannelType getType() {
