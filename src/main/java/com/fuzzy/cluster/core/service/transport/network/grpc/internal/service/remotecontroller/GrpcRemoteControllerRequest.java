...
import com.infomaximum.cluster.core.service.transport.network.grpc.struct.PNetPackageProcessing;
...
public class GrpcRemoteControllerRequest implements RemoteControllerRequest {
    ...
    private final ConcurrentHashMap<Integer, com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.NetRequest> requests;

    private final ScheduledExecutorService scheduledServiceWaitNetExecute;

    private final ConcurrentHashMap<com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.WaitLocalExecute, com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.WaitLocalExecuteResult> waitLocalExecuteRequest;
    ...
    public ComponentExecutorTransport.Result request(Component sourceComponent, UUID targetNodeRuntimeId, int targetComponentId, String rControllerClassName, int methodKey, byte[][] args) throws Exception {
        ...
        requests.put(packageId, new com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.NetRequest(targetNodeRuntimeId, targetComponentId, rControllerClassName, methodKey, new com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.Timeout(countTimeFail()), completableFuture));
        try {
    ...
    public void handleIncomingPacket(PNetPackageResponse response) {
        com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.NetRequest netRequest = requests.remove(response.getPackageId());
        if (netRequest == null) {
    ...
    public void handleIncomingPacket(PNetPackageProcessing response) {
        com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.NetRequest netRequest = requests.get(response.getPackageId());
        if (netRequest == null) {
            log.debug("Incoming unknown package: {}", PackageLog.toString(response));
        } else {
    ...
    public void handleIncomingPacket(PNetPackageRequest request, ChannelImpl channel) {
        ...
        com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.WaitLocalExecute waitLocalExecute = new com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.WaitLocalExecute(remoteNodeRuntimeId, packageId);
        com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.WaitLocalExecuteResult waitLocalExecuteResult = new com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.WaitLocalExecuteResult();
    ...
    public void disconnectChannel(Channel channel) {
        for (Map.Entry<Integer, com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.NetRequest> entry : requests.entrySet()) {
            com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.NetRequest netRequest = entry.getValue();
    ...
    private void sendWaitResponsePackets(){
        ...
        for (Map.Entry<com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.WaitLocalExecute, com.fuzzy.cluster.core.service.transport.network.grpc.internal.service.remotecontroller.WaitLocalExecuteResult> entry : waitLocalExecuteRequest.entrySet()) {
