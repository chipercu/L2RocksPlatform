...
import com.fuzzy.cluster.core.remote.utils.validatorremoteobject.RemoteObjectValidator;
import com.fuzzy.cluster.core.remote.utils.validatorremoteobject.ResultValidator;
import com.fuzzy.cluster.graphql.anotation.*;
...
public class TypeGraphQLBuilder {
    ...
    public Map<Class, RGraphQLType> build() throws GraphQLExecutorException {
        ...
        for (Class classRTypeGraphQL : reflections.getTypesAnnotatedWith(GraphQLTypeInput.class)) {
            ...
            //Обрабытываем поля
            Constructor constructor = com.fuzzy.cluster.graphql.utils.ReflectionUtils.getGConstructor(classRTypeGraphQL);
            if (constructor == null) {
