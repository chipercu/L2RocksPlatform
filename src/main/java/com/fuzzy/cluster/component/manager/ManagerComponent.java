package com.fuzzy.cluster.component.manager;

import com.fuzzy.cluster.Cluster;
import com.fuzzy.cluster.anotation.Info;
import com.fuzzy.cluster.component.manager.core.ManagerRegisterComponents;
...
public class ManagerComponent extends Component {
    ...
    public static final String UUID = "com.fuzzy.cluster.component.manager";
