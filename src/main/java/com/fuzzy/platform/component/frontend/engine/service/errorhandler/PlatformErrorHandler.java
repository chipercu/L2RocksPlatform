package com.fuzzy.platform.component.frontend.engine.service.errorhandler;
...
public class PlatformErrorHandler extends ErrorHandler {
    ...
    private final com.fuzzy.platform.component.frontend.engine.service.errorhandler.ActionErrorHandler actionErrorHandler;
    ...
    private void processingException(Throwable ex, Request baseRequest, HttpServletResponse response) {
        ...
        if (ex instanceof EofException) {
            ...
            return;
                ...
                && chainThrowables.get(2) instanceof MultipartException
            ...
            return;
                ...
                && chainThrowables.get(1) instanceof ServletException
                && chainThrowables.get(2) instanceof MultipartException
                && chainThrowables.get(3) instanceof EofException
        ) {
