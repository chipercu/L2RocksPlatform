...
import com.fuzzy.platform.querypool.QueryFuture;
import com.fuzzy.platform.querypool.QueryTransaction;
import com.fuzzy.platform.querypool.ResourceProviderImpl;
import com.fuzzy.platform.querypool.service.DetectHighLoad;
import com.fuzzy.platform.querypool.service.DetectLongQuery;
import com.fuzzy.platform.querypool.service.DetectQueueFilling;
import com.fuzzy.platform.querypool.service.threadcontext.ThreadContext;
import com.fuzzy.platform.querypool.service.threadcontext.ThreadContextImpl;
...
import com.fuzzy.platform.utils.DefaultThreadPoolExecutor;
import com.fuzzy.platform.utils.LockGuard;
...
public class QueryPool {
    ...
    public static class QueryWrapper<T> {
        ...
        final com.fuzzy.platform.querypool.Query<T> query;
        ...
        QueryWrapper(QueryPool queryPool, Component component, ContextTransaction context, com.fuzzy.platform.querypool.Query<T> query) throws PlatformException {
            this(new QueryFuture<T>(queryPool, component, context, new CompletableFuture<>()), query);
        }

        QueryWrapper(QueryFuture<T> queryFuture, com.fuzzy.platform.querypool.Query<T> query) throws PlatformException {
    ...
    protected <T> void execute(QueryFuture<T> queryFuture, com.fuzzy.platform.querypool.Query<T> query, boolean failIfPoolBusy) {
    ...
    public <T> QueryFuture<T> execute(Component component, com.fuzzy.platform.querypool.Query<T> query) {
        return execute(component, null, query, true);
    }

    public <T> QueryFuture<T> execute(Component component, ContextTransaction context, com.fuzzy.platform.querypool.Query<T> query) {
        return execute(component, context, query, true);
    }

    public <T> QueryFuture<T> execute(Component component, ContextTransaction context, com.fuzzy.platform.querypool.Query<T> query, boolean failIfPoolBusy) {
        QueryWrapper<T> queryWrapp;
        try {
     ...
     */
    public <T> QueryFuture<T> tryExecuteImmediately(Component component, com.fuzzy.platform.querypool.Query<T> query) throws PlatformException {
