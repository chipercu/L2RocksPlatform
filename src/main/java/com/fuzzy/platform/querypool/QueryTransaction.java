...
import com.fuzzy.platform.querypool.ByteKey;
...
public class QueryTransaction implements AutoCloseable {
    ...
    private Map<com.fuzzy.platform.querypool.ByteKey, CommitListener> commitListenerMap;
    ...
    public void addCommitListener(byte[] key, CommitListener listener) {
        ...
        commitListenerMap.put(new com.fuzzy.platform.querypool.ByteKey(key), listener);
    }
