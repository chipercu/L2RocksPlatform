...
public class TRangeIndex extends TBaseIndex {
    ...
    public TRangeIndex(com.fuzzy.database.schema.table.TField beginField, com.fuzzy.database.schema.table.TField endField) {
    ...
    public TRangeIndex(com.fuzzy.database.schema.table.TField beginField, com.fuzzy.database.schema.table.TField endField, com.fuzzy.database.schema.table.TField[] hashedFields) {
