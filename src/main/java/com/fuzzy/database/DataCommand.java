...
import com.fuzzy.database.exception.InvalidValueException;
import com.fuzzy.database.exception.UnexpectedFieldValueException;
...
import com.fuzzy.database.utils.*;
...
public class DataCommand extends DataReadCommand {
    ...
    public long insertRecord(String tableName, String namespace, Object[] values) throws DatabaseException {
        ...
        com.fuzzy.database.Record record = new com.fuzzy.database.Record(id, values);
    ...
    public long updateRecord(String tableName, String namespace, com.fuzzy.database.Record record) throws DatabaseException {
        com.fuzzy.database.Record prevRecord = getById(tableName, namespace, record.getId());
    ...
    public long updateRecord(String tableName, String namespace, long id, String[] fields, Object[] values) throws DatabaseException {
        ...
        com.fuzzy.database.Record prevRecord = getById(tableName, namespace, id);
    ...
    private long updateRecordSortedValues(String tableName, String namespace, long id, Object[] newValues, com.fuzzy.database.Record prevRecord) throws DatabaseException {
        if (newValues == null) {
            return -1;
        }
        if (id <= 0) {
        ...
        com.fuzzy.database.Record record = new com.fuzzy.database.Record(id, newValues);
        // update hash-indexed values
        for (DBHashIndex index : table.getHashIndexes()) {
    ...
    public void deleteRecord(String tableName, String namespace, long id) throws DatabaseException {
        ...
        com.fuzzy.database.Record record = getById(tableName, namespace, id);
    ...
    private static boolean anyChanged(int[] fieldIds, com.fuzzy.database.Record newRecord, com.fuzzy.database.Record prevRecord) {
    ...
    private void removeIndexedValue(DBHashIndex index, com.fuzzy.database.Record record, DBTable table) throws DatabaseException {
    ...
    private void createIndexedValue(DBHashIndex index, com.fuzzy.database.Record record, DBTable table) throws DatabaseException {
        final HashIndexKey indexKey = new HashIndexKey(record.getId(), index);
    ...
    private void updateIndexedValue(DBHashIndex index, com.fuzzy.database.Record prevRecord, com.fuzzy.database.Record record, DBTable table) throws DatabaseException {
        removeIndexedValue(index, prevRecord, table);
        createIndexedValue(index, record, table);
    }

    private void removeIndexedValue(DBPrefixIndex index, com.fuzzy.database.Record record, DBTable table) throws DatabaseException {
    ...
    private void createIndexedValue(DBPrefixIndex index, com.fuzzy.database.Record record, DBTable table) throws DatabaseException {
    ...
    private void updateIndexedValue(DBPrefixIndex index, com.fuzzy.database.Record prevRecord, com.fuzzy.database.Record record, DBTable table) throws DatabaseException {
    ...
    private void removeIndexedValue(DBIntervalIndex index, com.fuzzy.database.Record record, DBTable table) throws DatabaseException {
    ...
    private void createIndexedValue(DBIntervalIndex index, com.fuzzy.database.Record record, DBTable table) throws DatabaseException {
        final DBField[] hashedFields = table.getFields(index.getHashFieldIds());
        final DBField indexedField = table.getField(index.getIndexedFieldId());
        final IntervalIndexKey indexKey = new IntervalIndexKey(record.getId(), new long[hashedFields.length], index);
        // Add new value-index
    ...
    private void updateIndexedValue(DBIntervalIndex index, com.fuzzy.database.Record prevRecord, com.fuzzy.database.Record record, DBTable table) throws DatabaseException {
        removeIndexedValue(index, prevRecord, table);
        createIndexedValue(index, record, table);
    }

    private void removeIndexedValue(DBRangeIndex index, com.fuzzy.database.Record record, DBTable table) throws DatabaseException {
        final DBField[] hashedFields = table.getFields(index.getHashFieldIds());
    ...
    private void createIndexedValue(DBRangeIndex index, com.fuzzy.database.Record record, DBTable table) throws DatabaseException {
        final DBField[] hashedFields = table.getFields(index.getHashFieldIds());
        final RangeIndexKey indexKey = new RangeIndexKey(record.getId(), new long[hashedFields.length], index);
        // Add new value-index
        setHashValues(hashedFields, record, indexKey.getHashedValues());
    ...
    private void updateIndexedValue(DBRangeIndex index, com.fuzzy.database.Record prevRecord, com.fuzzy.database.Record record, DBTable table) throws DatabaseException {
        removeIndexedValue(index, prevRecord, table);
        createIndexedValue(index, record, table);
    }

    private static void setHashValues(DBField[] fields, com.fuzzy.database.Record record, long[] destination) {
