...
import com.fuzzy.database.exception.KeyCorruptedException;
...
public class HashIndexKey extends com.fuzzy.database.utils.key.IndexKey {
    ...
    @Override
    public byte[] pack() {
        byte[] buffer = com.fuzzy.database.utils.key.KeyUtils.allocateAndPutIndexAttendant(attendant.length + ID_BYTE_SIZE * fieldValues.length + ID_BYTE_SIZE,
                attendant);
    ...
    public static KeyPattern buildKeyPattern(final HashIndex index, final long[] fieldValues) {
        byte[] buffer = com.fuzzy.database.utils.key.KeyUtils.allocateAndPutIndexAttendant(index.attendant.length + ID_BYTE_SIZE * fieldValues.length,
                index.attendant);
    ...
    public static KeyPattern buildKeyPattern(final DBHashIndex index, final long[] fieldValues) {
        byte[] buffer = com.fuzzy.database.utils.key.KeyUtils.allocateAndPutIndexAttendant(index.getAttendant().length + ID_BYTE_SIZE * fieldValues.length,
                index.getAttendant());
    ...
    public static KeyPattern buildKeyPattern(final DBHashIndex index, final long fieldValue) {
        byte[] buffer = com.fuzzy.database.utils.key.KeyUtils.allocateAndPutIndexAttendant(index.getAttendant().length + ID_BYTE_SIZE,
                index.getAttendant());
    ...
    public static KeyPattern buildKeyPattern(final HashIndex index, final long fieldValue) {
        byte[] buffer = com.fuzzy.database.utils.key.KeyUtils.allocateAndPutIndexAttendant(index.attendant.length + ID_BYTE_SIZE,
                index.attendant);
