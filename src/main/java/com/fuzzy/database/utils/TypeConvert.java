...
public class TypeConvert {
    ...
    public static Integer unpackInteger(byte[] value) {
        return !com.fuzzy.database.utils.ByteUtils.isNullOrEmpty(value) ? unpackInt(value) : null;
    }
    ...
    public static Long unpackLong(byte[] value) {
        return !com.fuzzy.database.utils.ByteUtils.isNullOrEmpty(value) ? unpackLong(value, 0) : null;
    }
    ...
    public static Double unpackDouble(byte[] value) {
        return !com.fuzzy.database.utils.ByteUtils.isNullOrEmpty(value) ? unpackDoublePrim(value) : null;
    }
    ...
    public static Boolean unpackBoolean(byte[] value) {
        return !com.fuzzy.database.utils.ByteUtils.isNullOrEmpty(value) ? value[0] == (byte) 1 : null;
    }

    public static Instant unpackInstant(byte[] value) {
        return !com.fuzzy.database.utils.ByteUtils.isNullOrEmpty(value) ? InstantUtils.fromLong(Longs.fromByteArray(value)) : null;
    }

    public static LocalDateTime unpackLocalDateTime(byte[] value) {
        return !com.fuzzy.database.utils.ByteUtils.isNullOrEmpty(value) ? LocalDateTimeUtils.fromLong(Longs.fromByteArray(value)) : null;
    }
