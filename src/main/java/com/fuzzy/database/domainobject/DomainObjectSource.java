...
public class DomainObjectSource extends DataEnumerable {
    ...
    public interface Monad {
         ...
         */
        void action(final com.fuzzy.database.domainobject.Transaction transaction) throws Exception;
    }
    ...
    public interface Function<R> {
         ...
         * @throws Exception Если во время выполнения операции возникла ошибка.
         */
        R apply(final com.fuzzy.database.domainobject.Transaction transaction) throws Exception;
    }
    ...
    public void executeTransactional(final Monad operation) throws Exception {
        try (com.fuzzy.database.domainobject.Transaction transaction = buildTransaction(true)) {
    ...
    public <R> R executeFunctionTransactional(final Function<R> operation) throws Exception {
        try (com.fuzzy.database.domainobject.Transaction transaction = buildTransaction()) {
    ...
    public com.fuzzy.database.domainobject.Transaction buildTransaction() {
        return new com.fuzzy.database.domainobject.Transaction(getDbProvider(), false);
    }

    public com.fuzzy.database.domainobject.Transaction buildTransaction(Boolean reloadSchema) {
