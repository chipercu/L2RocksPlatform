...
import com.fuzzy.database.domainobject.iterator.*;
...
public abstract class DataEnumerable {
    ...
    public <T extends com.fuzzy.database.domainobject.DomainObject> T get(final Class<T> clazz, long id, final Set<Integer> loadingFields) throws DatabaseException {
        ...
        try (DBIterator iterator = createIterator(entity.getColumnFamily())) {
            return seekObject(com.fuzzy.database.domainobject.DomainObject.getConstructor(clazz), loadingFields, iterator, FieldKey.buildKeyPattern(id, entity.getFieldNames(loadingFields)));
        }
    }

    public <T extends com.fuzzy.database.domainobject.DomainObject> T get(final Class<T> clazz, long id) throws DatabaseException {
        return get(clazz, id, null);
    }

    public <T extends com.fuzzy.database.domainobject.DomainObject> IteratorEntity<T> find(final Class<T> clazz, Filter filter, final Set<Integer> loadingFields) throws DatabaseException {
    ...
    public <T extends com.fuzzy.database.domainobject.DomainObject> IteratorEntity<T> find(final Class<T> clazz, Filter filter) throws DatabaseException {
        return find(clazz, filter, null);
    }

    public <T extends com.fuzzy.database.domainobject.DomainObject> T buildDomainObject(final Constructor<T> constructor, long id, Collection<Integer> preInitializedFields) {
    ...
    private <T extends com.fuzzy.database.domainobject.DomainObject> T buildDomainObject(final Constructor<T> constructor, long id) {
        try {
    ...
    public <T extends com.fuzzy.database.domainobject.DomainObject> T nextObject(final Constructor<T> constructor, Collection<Integer> preInitializedFields,
    ...
    public <T extends com.fuzzy.database.domainobject.DomainObject> T seekObject(final Constructor<T> constructor, Collection<Integer> preInitializedFields,
