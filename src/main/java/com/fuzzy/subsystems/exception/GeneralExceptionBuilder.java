...
public class GeneralExceptionBuilder {
    ...
    public static final String NOT_FOUND_DOMAIN_OBJECT_CODE =
            com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.NOT_FOUND_DOMAIN_OBJECT_CODE;
    public static final String ACCESS_DENIED_CODE =
            com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.ACCESS_DENIED_CODE;
    public static final String NOT_EMPTY_DOMAIN_OBJECT_CODE =
            com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.NOT_EMPTY_DOMAIN_OBJECT_CODE;

    private GeneralExceptionBuilder() {
    }

    public static PlatformException buildDatabaseException(DatabaseException cause) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildDatabaseException(cause);
    }

    public static PlatformException buildDatabaseException(DatabaseException cause, Map<String, Object> params) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildDatabaseException(cause, params);
    }

    public static PlatformException buildNotFoundDomainObjectException(Class<? extends DomainObject> clazz, Long id) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildNotFoundDomainObjectException(clazz, id);
    }
    ...
    public static PlatformException buildNotFoundDomainObjectException(Class<? extends DomainObject> clazz, int fieldNumber, Object fieldValue) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildNotFoundDomainObjectException(clazz, fieldNumber, fieldValue);
    }

    public static PlatformException buildDomainObjectAlreadyExistsException(Class<? extends DomainObject> clazz, Long id) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildDomainObjectAlreadyExistsException(clazz, id);
    }

    public static PlatformException buildNotEmptyDomainObjectException(Class<? extends DomainObject> clazz) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildNotEmptyDomainObjectException(clazz);
    }
    ...
    public static Map<String, Object> buildParams(Class<? extends DomainObject> clazz, int fieldNumber) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildParams(clazz, fieldNumber);
    }

    public static Map<String, Object> buildParams(Class<? extends DomainObject> clazz, int fieldNumber, Object fieldValue) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildParams(clazz, fieldNumber, fieldValue);
    }

    public static PlatformException buildInvalidCredentialsException() {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildInvalidCredentialsException();
    }

    public static PlatformException buildInvalidCredentialsException(String type, String name) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildInvalidCredentialsException(type, name);
    }

    public static PlatformException buildInvalidJsonException() {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildInvalidJsonException();
    }

    public static PlatformException buildGraphQLInvalidSyntaxException() {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildGraphQLInvalidSyntaxException();
    }

    public static PlatformException buildGraphQLValidationException() {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildGraphQLValidationException();
    }

    public static PlatformException buildGraphQLValidationException(String message) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildGraphQLValidationException(message);
    }

    public static PlatformException buildInvalidJsonException(Throwable cause) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildInvalidJsonException(cause);
    }

    public static PlatformException buildIllegalStateException(String message) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildIllegalStateException(message);
    }

    public static PlatformException buildIOErrorException(IOException e) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildIOErrorException(e);
    }

    public static PlatformException buildSecurityException(SecurityException e) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildSecurityException(e);
    }

    public static PlatformException buildEmptyValueException(String fieldName) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildEmptyValueException(fieldName);
    }

    public static PlatformException buildEmptyValueException(Class<? extends DomainObject> clazz, int fieldNumber) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildEmptyValueException(clazz, fieldNumber);
    }
    ...
    public static PlatformException buildNotUniqueValueException(Class<? extends DomainObject> clazz, int fieldNumber, Object fieldValue) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildNotUniqueValueException(clazz, fieldNumber, fieldValue);
    }

    public static PlatformException buildNotUniqueValueException(String name, Object value) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildNotUniqueValueException(name, value);
    }

    public static PlatformException buildInvalidValueException(String fieldName) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildInvalidValueException(fieldName);
    }

    public static PlatformException buildInvalidValueExceptionWithCause(String cause) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildInvalidValueExceptionWithCause(cause);
    }

    public static PlatformException buildInvalidValueException(String fieldName, Serializable fieldValue) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildInvalidValueException(fieldName, fieldValue);
    }

    public static PlatformException buildInvalidValueException(String fieldName, Serializable fieldValue, String comment) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildInvalidValueException(fieldName, fieldValue, comment);
    }
    ...
    public static PlatformException buildInvalidValueException(Class<? extends DomainObject> clazz, int fieldNumber, Serializable fieldValue) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildInvalidValueException(clazz, fieldNumber, fieldValue);
    }
    ...
    public static PlatformException buildInvalidValueException(Class<? extends DomainObject> clazz, int fieldNumber, Serializable fieldValue, String comment) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildInvalidValueException(clazz, fieldNumber, fieldValue, comment);
    }

    public static PlatformException buildAccessDeniedException() {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildAccessDeniedException();
    }

    public static PlatformException buildServerBusyException(String cause) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildServerBusyException(cause);
    }

    public static PlatformException buildServerOverloadedException() {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildServerOverloadedException();
    }

    public static PlatformException buildServerTimeoutException() {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildServerTimeoutException();
    }

    public static PlatformException buildServerShutsDownException() {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildServerShutsDownException();
    }
    ...
    public static PlatformException buildUploadFileNotFoundException() {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildUploadFileNotFoundException();
    }

    public static PlatformException buildAuthAmbiguityException(String message) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildAuthAmbiguityException(message);
    }
    ...
    public static PlatformException buildNotFoundObligatoryParam(Class<? extends DomainObject> clazz, int fieldNumber) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildNotFoundObligatoryParam(clazz, fieldNumber);
    }

    public static PlatformException buildNotFoundObligatoryParam(String fieldName) {
        return com.fuzzy.platform.sdk.exception.GeneralExceptionBuilder.buildNotFoundObligatoryParam(fieldName);
    }
