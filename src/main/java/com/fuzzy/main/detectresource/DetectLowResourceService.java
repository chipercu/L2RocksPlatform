package com.fuzzy.main.detectresource;

import com.fuzzy.main.detectresource.observer.ResourceObservable;
...
import com.fuzzy.main.detectresource.resourcemonitor.cpuresourcesmonitor.CpuHostResourcesMonitor;
import com.fuzzy.main.detectresource.resourcemonitor.cpuresourcesmonitor.CpuJvmResourcesMonitor;
import com.fuzzy.main.detectresource.resourcemonitor.diskresourcesmonitor.DiskHostResourceMonitor;
import com.fuzzy.main.detectresource.resourcemonitor.diskresourcesmonitor.DiskJvmResourceMonitor;
import com.fuzzy.main.detectresource.resourcemonitor.memoryresourcesmonitor.MemoryHostResourceMonitor;
import com.fuzzy.main.detectresource.resourcemonitor.memoryresourcesmonitor.MemoryJvmResourceMonitor;
...
public class DetectLowResourceService implements Callable<Void> {
    ...
    private void executeMonitors(List<ResourceMonitor> executedMonitors, Instant start) throws PlatformException {
        for (ResourceMonitor executedMonitor : executedMonitors) {
            ...
            if (!check.getEvent().equals(ResourceMonitorStatus.NORMAL)) {
