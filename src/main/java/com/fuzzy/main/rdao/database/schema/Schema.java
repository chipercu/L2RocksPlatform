...
import com.fuzzy.main.rdao.database.exception.*;
...
import com.fuzzy.main.rdao.database.utils.IndexService;
import com.fuzzy.main.rdao.database.utils.TableUtils;
...
public class Schema {
    ...
    public static List<StructEntity> getEntitys(String namespace) {
        return objTables.values().stream()
                .filter(entity -> entity.getNamespace().equals(namespace))
                .toList();
    }
