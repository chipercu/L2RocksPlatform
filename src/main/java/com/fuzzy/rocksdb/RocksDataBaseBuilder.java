...
import com.fuzzy.database.utils.PathUtils;
import com.fuzzy.database.utils.TempLibraryCleaner;
...
import com.fuzzy.rocksdb.options.columnfamily.ColumnFamilyConfigService;
import org.rocksdb.*;
...
public class RocksDataBaseBuilder {
    ...
    public com.fuzzy.rocksdb.RocksDBProvider build() throws DatabaseException {
        ...
        try (DBOptions options = buildOptions()) {
            ...
            return new com.fuzzy.rocksdb.RocksDBProvider(rocksDB, columnFamilies);
