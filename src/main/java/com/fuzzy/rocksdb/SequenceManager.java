...
import com.fuzzy.database.exception.SequenceAlreadyExistsException;
...
public class SequenceManager {
    ...
    private final com.fuzzy.rocksdb.RocksDBProvider dbProvider;
    private final ColumnFamilyHandle defaultColumnFamily;
    private final ConcurrentMap<String, Sequence> sequences = new ConcurrentHashMap<>();

    public SequenceManager(com.fuzzy.rocksdb.RocksDBProvider dbProvider) throws DatabaseException {
        this.dbProvider = dbProvider;
        this.defaultColumnFamily = dbProvider.getColumnFamilyHandle(com.fuzzy.rocksdb.RocksDBProvider.DEFAULT_COLUMN_FAMILY);
        readSequences();
    }
