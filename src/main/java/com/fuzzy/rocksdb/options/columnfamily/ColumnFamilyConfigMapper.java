...
public class ColumnFamilyConfigMapper {
    ...
    public static ColumnFamilyOptions toRocksDbOpt(com.fuzzy.rocksdb.options.columnfamily.ColumnFamilyConfig from) {
    ...
    public static com.fuzzy.rocksdb.options.columnfamily.ColumnFamilyConfig fromRocksDbOpt(ColumnFamilyOptions from) {
        Objects.requireNonNull(from);
        return com.fuzzy.rocksdb.options.columnfamily.ColumnFamilyConfig.newBuilder()
