...
import com.fuzzy.network.executerequest.ExecuteRequest;
...
import com.fuzzy.network.transport.TransportPacketHandler;
...
public abstract class TransportSession implements TransportPacketHandler {
    ...
    protected final com.fuzzy.network.session.Session session;
