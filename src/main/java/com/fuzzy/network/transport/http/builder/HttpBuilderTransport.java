package com.fuzzy.network.transport.http.builder;
...
public class HttpBuilderTransport extends BuilderTransport {
    ...
    public static final com.fuzzy.network.transport.http.builder.ConfigUploadFiles DEFAULT_CONFIG_UPLOAD_FILES = new com.fuzzy.network.transport.http.builder.ConfigUploadFiles.Builder().build();
    ...
    public HttpBuilderTransport(Class classWebMvcConfig, com.fuzzy.network.transport.http.builder.ConfigUploadFiles configUploadFiles) {
